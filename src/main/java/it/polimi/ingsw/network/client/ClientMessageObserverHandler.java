...
public class ClientMessageObserverHandler implements Observer<CommunicationMessage> {
    ...
    public void update(CommunicationMessage message) {
        switch (message.getID()){
            ...
            case YOU_WIN -> new Thread(() -> view.displayEndGame(CommunicationMessage.MessageType.YOU_WIN));
            case YOU_LOSE -> new Thread(() -> view.displayEndGame(CommunicationMessage.MessageType.YOU_LOSE));
            case DRAW -> new Thread(() -> view.displayEndGame(CommunicationMessage.MessageType.DRAW));
        }
    }
